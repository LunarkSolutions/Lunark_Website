    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors">
      ...
      <section className="py-32 pb-40">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl lg:text-6xl animate-fadeInUp animate-delay-200">
              WatchEat
            </h1>
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto animate-fadeInUp animate-delay-400">
            ...
            <p className="mt-4 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto animate-fadeInUp animate-delay-600">
      ...
      <section className="py-32">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white animate-fadeInUp">How WatchEat Works</h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 animate-fadeInUp animate-delay-200">
      ...
      <section className="py-32">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto animate-fadeInUp animate-delay-200">
